  ...
  const project = await projectService.createProject(
    {
      ...
      status: data.status as "backlog" | "in_progress" | "on_track" | "at_risk" | "completed" | "cancelled",
      priority: data.priority as "no_priority" | "urgent" | "high" | "medium" | "low",
      lead: data.lead,
...
export async function updateProject(
  ...
  const project = await projectService.updateProject(projectId, {
    ...
    description: data.description,
    colorId: data.colorId,
    status: data.status as "backlog" | "in_progress" | "on_track" | "at_risk" | "completed" | "cancelled" | undefined,
    priority: data.priority as "no_priority" | "urgent" | "high" | "medium" | "low" | undefined,
    lead: data.lead,
